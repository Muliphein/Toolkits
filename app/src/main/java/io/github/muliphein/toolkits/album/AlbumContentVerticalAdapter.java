...
public class AlbumContentVerticalAdapter extends RecyclerView.Adapter<AlbumContentVerticalAdapter.AlbumContentViewHolder> {

    private static final String TAG = "AlbumContentAdapter";
    private final Album album;
    private final Context context;
    public AlbumContentVerticalAdapter(Context _context, Album _album){
        context = _context;
        album = _album;
    }
    ...
    public AlbumContentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        return new AlbumContentViewHolder(LayoutInflater.from(context).inflate(R.layout.item_recyclerview, parent, false));
    }
    ...
    static class AlbumContentViewHolder extends RecyclerView.ViewHolder {
        ...
        AlbumContentViewHolder (@NonNull View view){
            super(view);
            imageView = view.findViewById(R.id.picture_listview);
            textView = view.findViewById(R.id.text_listview);
        }
    }
